  ...
  [:div.container
   ...
   [:ul
    ...
    [:li [:p "Start making your webapp!"]
     [:ul
      [:li [:p "The CLJS entry point is in " [code "ui-src/blog/ui/app.cljs"]]]
      [:li [:p "The Clojure entry point is in " [code "src/blog/service/main.clj"]]]
      [:li [:p "The Clojure Ring handler is in " [code "src/blog/service/handler.clj"]]]]]
